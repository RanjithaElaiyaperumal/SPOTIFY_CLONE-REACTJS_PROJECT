...
//   // Dummy data for library items (replace with real data)
//   const libraryItems = [
//     { id: 1, name: "Song One" },
//     { id: 2, name: "Workout Pump" },
//     { id: 3, name: "Classical Hits" },
//     { id: 4, name: "Hip-Hop Mix" },
//   ];

//   // Filtering library items based on search term
...
//               <p key={item.id} className="p-2 bg-[#242424] m-1 rounded text-white">
//                 {item.name}
//               </p>
//             ))
//           ) : (
